...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickSave (final View v) {
        Toast.makeText(MainActivity.this, "Painting added to gallery", Toast.LENGTH_SHORT).show();
        _impressionistView.savePainting(v.getContext());
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuPaint:
                Toast.makeText(this, "Paint Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Paint);
                return true;
            case R.id.menuCharcoal:
                Toast.makeText(this, "Charcoal", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Charcoal);
                return true;
            case R.id.menuScribble:
                Toast.makeText(this, "Scribble Pencil", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Scribble);
                return true;
            case R.id.menuRed:
                Toast.makeText(this, "Red Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Red);
                return true;
            case R.id.menuGreen:
                Toast.makeText(this, "Green Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Green);
                return true;
            case R.id.menuBlue:
                Toast.makeText(this, "Blue Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Blue);
                return true;
        }
        return false;
    }
